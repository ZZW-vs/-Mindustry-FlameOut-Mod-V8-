...
public class EmpathyUnit extends UnitEntity{
    ...
    public static EmpathyUnit createUnit(){
        return createUnit(null);
    }

    public static EmpathyUnit createUnit(EmpathyTransferData last){
        ...
        return new EmpathyUnit(){
            ...
            EmpathyUnit duplicate(){
                ...
                u1.setType(type);
                //u1.team = tm[0];
                flame.Utils.setUnitAmmo(u1, flame.Utils.getAmmoCapacity(type));
                u1.elevation = 1f;
                u1.copyFields(this);
                u1.team = tm[0];
    ...
    protected void updateTrueValues(){
        ...
        if(!playerControlled && stunTimer <= 0f){
    ...
    */
    ...
    EmpathyUnit duplicate(){
        ...
        u.team = team;
        u.setType(type);
        flame.Utils.setUnitAmmo(u, flame.Utils.getAmmoCapacity(type));
        u.elevation = 1f;
        u.copyFields(this);
        u.decoyDelay = 2f * 60;
