...
public class Utils{
    private static final java.lang.reflect.Field useAmmoField;

    static{
        java.lang.reflect.Field f = null;
        try{
            f = mindustry.type.Weapon.class.getField("useAmmo");
        }catch(Throwable ignored){
        }
        useAmmoField = f;
    }

    public static boolean hasUseAmmo(){
        return useAmmoField != null;
    }

    public static void setUseAmmo(mindustry.type.Weapon weapon, boolean value){
        if(useAmmoField != null){
            try{
                useAmmoField.set(weapon, value);
            }catch(Throwable ignored){
            }
        }
    }

    public static boolean getUseAmmo(mindustry.type.Weapon weapon){
        if(useAmmoField != null){
            try{
                return useAmmoField.getBoolean(weapon);
            }catch(Throwable ignored){
            }
        }
        return false;
    ...
    private static final java.lang.reflect.Field unitAmmoField;

    static{
        java.lang.reflect.Field f = null;
        try{
            f = mindustry.gen.Unit.class.getField("ammo");
        }catch(Throwable ignored){
        }
        unitAmmoField = f;
    }

    public static boolean hasUnitAmmo(){
        return unitAmmoField != null;
    }

    public static void setUnitAmmo(mindustry.gen.Unit unit, float value){
        if(unitAmmoField != null){
            try{
                unitAmmoField.setFloat(unit, value);
            }catch(Throwable ignored){
            }
        }
    }

    public static float getUnitAmmo(mindustry.gen.Unit unit){
        if(unitAmmoField != null){
            try{
                return unitAmmoField.getFloat(unit);
            }catch(Throwable ignored){
            }
        }
        return 0f;
    ...
    private static final java.lang.reflect.Field ammoCapacityField;

    static{
        java.lang.reflect.Field f = null;
        try{
            f = mindustry.type.UnitType.class.getField("ammoCapacity");
        }catch(Throwable ignored){
        }
        ammoCapacityField = f;
    }

    public static float getAmmoCapacity(mindustry.type.UnitType type){
        if(ammoCapacityField != null){
            try{
                return ammoCapacityField.getFloat(type);
            }catch(Throwable ignored){
            }
        }
        return 0f;
